...
if (isset($_POST["submit"])) {
    ...
    if (tambah($_POST, "resep_dokter") > 0) {
        echo "
            <script>
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="w-full max-w-lg p-8 bg-white shadow-md rounded-lg">
        ...
        <h1 class="text-2xl font-bold mb-6"> Tambah Resep Dokter </h1>
        ...
        <form action=""
            ...
            <div>
                ...
                <input type="date" name="tanggal_resep" id="tanggal" required>Tanggal Resep
            </div>
